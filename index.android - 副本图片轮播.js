...
class AwesomeProject extends Component {
    ...
    render() {
        ...
        return(
            <Carousel>
                <Image source={require('./img/first.jpg')} style={{height:170}}/>
                <Image source={require('./img/second.jpg')} style={{height:170}}/>
                <Image source={require('./img/third.jpg')} style={{height:170}}/>
                <Image source={require('./img/fourth.jpg')} style={{height:170}}/>
            </Carousel>
        )
