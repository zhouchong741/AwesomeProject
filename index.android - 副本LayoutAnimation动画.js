...
class AwesomeProject extends Component {
    ...
    renderCircle(key) {
        ...
        return (
            <View key={key}
                  style={{width: size, height: size, borderRadius: size / 2.0, backgroundColor: 'sandybrown', margin: 20}}/>
        );
    }
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <View
                        style={{height: whiteHeight, justifyContent: 'center', alignItems: 'center', overflow: 'hidden'}}
